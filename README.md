...
- figures и два агрегированных файла из `data/output/` доступны внутри репозитория;
- файлы из `data/interim/` и остальные производные файлы из `data/output/` рассматриваются как локальные артефакты и не коммитятся;
